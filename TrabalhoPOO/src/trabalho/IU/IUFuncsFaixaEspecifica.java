 ...
 * @author vitor
 */
public class IUFuncsFaixaEspecifica extends javax.swing.JDialog {
    private DefaultTableModel model;

    /**
     * Creates new form IUBuscarFuncionarioNome
     */
    public IUFuncsFaixaEspecifica(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        ArrayList<Funcionario> funcsFaixa = control.getTodosFuncionariosGastoEspecifico(ini, fim);
        Object linha[] = new Object[4];
        for(int i=0; i < funcsFaixa.size(); i++){
            linha[0] = funcsFaixa.get(i).getCodigo();
            linha[1] = funcsFaixa.get(i).getNome();
            linha[2] = funcsFaixa.get(i).calcularSalario();
            linha[3] = funcsFaixa.get(i).getNivel();
            model.addRow(linha);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUFuncsFaixaEspecifica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
