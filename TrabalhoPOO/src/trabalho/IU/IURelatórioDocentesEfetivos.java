 ...
 * @author vitor
 */
public class IURelatórioDocentesEfetivos extends javax.swing.JDialog {
    private DefaultTableModel model;

    /**
     * Creates new form IURelatórioTecnicos
     */
    public IURelatórioDocentesEfetivos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setResizable(false);
        String colunas[] = {"Código", "Nome", "Salário", "Nível", "Titulação", "Área"};
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de todos os docentes efetivos");
    ...
    private void ExibirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExibirActionPerformed
        ...
        ArrayList<Efetivo> docentes = control.getTodosDocentesEfetivos();
        for(int i=0; i < docentes.size(); i++){
            ...
            linha[5] = docentes.get(i).getArea();
            model.addRow(linha);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IURelatórioDocentesEfetivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
